...
const colors = {
  ru: ['Белый', 'Бежевый', 'Серый', 'Синий', 'Зелёный', 'Бордовый', 'Темно синий', 'Серо-голубой', 'Светло-серый', 'Голубой', 'Молочный'],
  kz: ['Ақ','Қоныр-сарғыш', 'Сұр', 'Көк', 'Жасыл', 'Қызғылт қоңыр', 'Кою көк', 'Сұр-көк', 'Ашық-сұр', 'Көгілдір', 'Сүтті'],
};
const rooms = {
  ru: ['Гостиная', 'Спальня', 'Кухня', 'Детская', 'Кабинет'],
  kz: ['Қонақ бөлме', 'Жатын бөлме', 'Ас үй', 'Балалар бөлмесі', 'Кабинет'],
};
...
const products = [
  ...
  { id: 5, name: { ru: 'Шторы Кантри', kz: 'Кантри перделер' }, price: 43480, design: { ru: 'Кантри', kz: 'Кантри' }, color: { ru: 'Зелёный', kz: 'Жасыл' }, room: { ru: 'Детская', kz: 'Балалар бөлмесі' }, desc: { ru: 'Кантри для детской, мягкий зелёный оттенок.', kz: 'Балаларға кантри, қолайлы жасыл түс.' }, img: 'https://i.pinimg.com/736x/5c/58/dc/5c58dcef253a6bc9a390b48759203e9d.jpg' },
  ...
  { id: 8, name: { ru: 'Шторы Минимализм', kz: 'Минимализм перделер' }, price: 70000, design: { ru: 'Минимализм', kz: 'Минимализм' }, color: { ru: 'Голубой', kz: 'Көгілдір' }, room: { ru: 'Гостиная', kz: 'Қонақ бөлме' }, desc: { ru: 'Современный минималистичный с элементами классики,шторы выглядят элегантно и сдержанно.', kz: 'Заманауи классика элеметтерімен үйлескен минимализм,перделер сәнді әрі ұстамды көрінеді.' }, img: 'https://i.pinimg.com/1200x/19/46/f1/1946f1c86c5999ebcc0258460b300010.jpg' },
  ...
  { id: 13, name: { ru: 'Шторы Модерн', kz: 'Модерн перделер' }, price: 40000, design: { ru: 'Модерн', kz: 'Модерн' }, color: { ru: 'Светло-Серый', kz: 'Ашық-сұр' }, room: { ru: 'Кабинет', kz: 'Кабинет' }, desc: { ru: 'Визуально увеличивают высоту комнаты за счет ввертикальных складок,светлый цвет освежает комнату и делает ее светлее.', kz: 'Бөлме биіктігін визуалды түрде арттырады - тік қатпарлар арқасында,ашық түс бөлмені сергітіп,жарық әрі кең етіп көрсетеді.' }, img: 'https://i.pinimg.com/736x/df/54/8a/df548aa57d097da900dfef68ab66b465.jpg' },
  { id: 14, name: { ru: 'Шторы Кантри', kz: 'Кантри перделер' }, price: 33000, design: { ru: 'Кантри', kz: 'Кантри' }, color: { ru: 'Бежевый - Коричневый', kz: 'Қоңыр-сарғыш-Қоңыр' }, room: { ru: 'Кухня', kz: 'Ас үй' }, desc: { ru: 'Легкие ткани пропускает свет,сохраняя уединенность подходят как для классических,так и для современных интерьеров.', kz: 'Жеңіл маталар жарықты өткізеді,бірақ жеке кеңістікті сақтайды классикалық және заманауи интерьерлерге де жарасады.' }, img: 'https://i.pinimg.com/1200x/d9/7c/b7/d97cb708e5a8639dd30dc909a47cbae8.jpg' },
  { id: 15, name: { ru: 'Шторы Модерн', kz: 'Модерн перделер' }, price: 68000, design: { ru: 'Модерн', kz: 'Модерн' }, color: { ru: 'Голубой', kz: 'Көгілдір' }, room: { ru: 'Детская', kz: 'Балалар бөлмесі' }, desc: { ru: 'Отлично регулируют свет можно комбинировать плотность слоя,смотрится дорого и стильно при правильной устоновке.', kz: 'Жарықты тамаша реттейді қабаттардың тығыздығын өзгертуге болады,бұл перделер қымбаты әрі стильді көрінеді.' }, img: 'https://i.pinimg.com/736x/7a/af/15/7aaf153788e7b03eeea120c61ddd2515.jpg' },
  { id: 16, name: { ru: 'Шторы Классика', kz: 'Классика перделер' }, price: 121000, design: { ru: 'Классика', kz: 'Классика' }, color: { ru: 'Голубой - Молочный', kz: 'Көгілдір - Сүтті' }, room: { ru: 'Гостиная', kz: 'Қонақ бөлме' }, desc: { ru: 'Двойные шторы с богатым орнаментом объемный драпировкой,украшенный декоративным кантом с бахромой.', kz: 'Бай өрнектелген және көлемді драпировкасы бар қос перде,перделер сәндік таспамен және бахромамен әшекейленген.' }, img: 'https://i.pinimg.com/1200x/32/c6/0f/32c60fa54e50c0ce70e9d71079be5389.jpg' },
  { id: 17, name: { ru: 'Шторы Классика', kz: 'Классика перделер' }, price: 130000, design: { ru: 'Классика', kz: 'Классика' }, color: { ru: 'Темно-Серый', kz: 'Қою-Сұр' }, room: { ru: 'Гостиная', kz: 'Қонақ бөлме' }, desc: { ru: 'Шторы оформленый в современной классике с элементами гламура,интерьер выглядит дорогим но не вычурным.', kz: 'Перделер заманауи классика стилінде гламур элементтерімен безендірілген,интерьер қымбат бірақ жасанды емес көрінеді.' }, img: 'https://i.pinimg.com/736x/5b/33/1a/5b331a552f15cdc777fbf4c6db130e07.jpg' },
];
...
export default function Catalog() {
  ...
  const filtered = products.filter(p => (
    ...
    (filter.colors.length === 0 || filter.colors.some(c => p.color[lang].includes(c))) &&
  ...
  const colorMap = {
    'Белый': '#fff', 'Бежевый': '#f5e8d7', 'Серый': '#bfc4c9', 'Синий': '#3a7bd5', 'Зелёный': '#7ecb8f', 'Бордовый': '#a8324a', 'Темно синий': '#232a4d', 'Серо-голубой': '#8faecb', 'Светло-серый': '#e0e4ea', 'Голубой': '#3a7bd5', 'Темно-Серый': '#23272f',
    'Ақ': '#fff', 'Қоныр-сарғыш': '#f5e8d7', 'Сұр': '#bfc4c9', 'Көк': '#3a7bd5', 'Жасыл': '#7ecb8f', 'Қызғылт қоңыр': '#a8324a', 'Кою көк': '#232a4d', 'Сұр-көк': '#8faecb',
    'Молочный': '#f9f6f2', 'Сүтті': '#f9f6f2', 'Ашық-сұр': '#e0e4ea', 'Көгілдір': '#3a7bd5','Қою-Сұр': '#23272f'
  };
  ...
  return (
    <>
      ...
      >
        {filterOpen ? t.hideFilter + ' ▲' : t.showFilter + ' ▼'}
      </button>
