...
const colors = {
  ru: ['Белый', 'Бежевый', 'Серый', 'Синий', 'Зелёный', 'Бордовый', 'Темно синий', 'Серо-голубой', 'Светло-серый'],
  kz: ['Ақ','Қоныр-сарғыш', 'Сұр', 'Көк', 'Жасыл', 'Қызғылт қоңыр', 'Кою көк', 'Сұр-көк', 'Ашық--сұр'],
};
const rooms = {
...
export default function Catalog() {
  ...
  const colorMap = {
    'Белый': '#fff', 'Бежевый': '#f5e8d7', 'Серый': '#bfc4c9', 'Синий': '#3a7bd5', 'Зелёный': '#7ecb8f', 'Бордовый': '#a8324a', 'Темно синий': '#232a4d', 'Серо-голубой': '#8faecb', 'Светло-серый': '#e0e4ea',
    'Ақ': '#fff', 'Қоныр-сарғыш': '#f5e8d7', 'Сұр': '#bfc4c9', 'Көк': '#3a7bd5', 'Жасыл': '#7ecb8f', 'Қызғылт қоңыр': '#a8324a', 'Кою көк': '#232a4d', 'Сұр-көк': '#8faecb',
    'Молочный': '#f9f6f2', 'Сүтті': '#f9f6f2', 'Ашық-сұр': '#e0e4ea'
  };
