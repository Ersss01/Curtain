...
const products = [
  ...
  { id: 7, name: { ru: 'Шторы Модерн', kz: 'Модерн перделер' }, price: 15500, design: { ru: 'Модерн', kz: 'Модерн' }, color: { ru: 'Бежевый', kz: 'Қоныр-сарғыш' }, room: { ru: 'Кухня', kz: 'Ас үй' }, desc: { ru: 'Модерн, бежевый цвет, для кухни.', kz: 'Модерн, беж түс, үйде қолайлы.' }, img: 'https://i.pinimg.com/736x/22/34/74/223474b88ebb187e1d494d919439e0b2.jpg' },
