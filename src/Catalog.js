...
const products = [
  ...
  { id: 8, name: { ru: 'Шторы Лофт', kz: 'Лофт перделер' }, price: 18000, design: { ru: 'Лофт', kz: 'Лофт' }, color: { ru: 'Серый', kz: 'Сұр' }, room: { ru: 'Спальня', kz: 'Жатын бөлме' }, desc: { ru: 'Лофт, серый цвет, для спальни.', kz: 'Лофт, сұр түс, жатын бөлмеге қолайлы.' }, img: 'https://ru.pinterest.com/pin/1103452346251873879/' },
  ...
  { id: 10, name: { ru: 'Шторы Классика', kz: 'Классика перделер' }, price: 18000, design: { ru: 'Классика', kz: 'Классика' }, color: { ru: 'Темно синий', kz: 'Кою көк' }, room: { ru: 'Гостиная', kz: 'Қонақ бөлме' }, desc: { ru: 'Классический стиль, плотная ткань, элегантные оттенки.', kz: 'Классикалық стиль, тығыз мата, элегантті түс.' }, img: 'https://ru.pinterest.com/pin/1103452346251873807/' },
