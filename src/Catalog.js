...
const colors = {
  ru: ['Белый', 'Бежевый', 'Серый', 'Синий', 'Зелёный', 'Бордовый', 'Темно синий', 'Серо-голубой', 'Светло-серый', 'Голубой'],
  kz: ['Ақ','Қоныр-сарғыш', 'Сұр', 'Көк', 'Жасыл', 'Қызғылт қоңыр', 'Кою көк', 'Сұр-көк', 'Ашық-сұр', 'Көгілдір'],
};
const rooms = {
